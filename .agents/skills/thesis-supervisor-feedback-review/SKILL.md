...
2. Re-check every P0/P1 claim against available assignment context, supervisor deadline context, thesis text, code, README, LaTeX sources, previous feedback, and notes.
...
7. Keep at most 8 priority rows, ideally 3-6.
8. Preserve concrete positives and a motivating but direct tone.
9. Make the final checklist specific to this thesis and phase, not generic.
10. Verify that priority and tone match the time remaining until the recommended finish and official deadline.
11. Respect the supervisor's declared "do not reopen now" boundary unless ignoring it would risk assignment fulfillment, technical truth, submission, or defense.
