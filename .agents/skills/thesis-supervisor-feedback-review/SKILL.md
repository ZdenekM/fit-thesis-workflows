...
Use this skill after a first version of supervisor feedback exists. When that first version was generated by an agent, this review should be run by a different reviewer agent or reviewer role. The goal is not to add more critique; the goal is to make the feedback fair, evidence-backed, phase-appropriate, concise, and sendable.
