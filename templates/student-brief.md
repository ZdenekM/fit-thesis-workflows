...
Write the brief in the case's `Student feedback language`. Where a factual value
cannot be verified, write the unresolved marker in the value position instead of
guessing; it blocks sending. See `docs/assignment-authoring.md`
`## Unresolved Values`.
