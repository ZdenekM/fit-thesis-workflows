...
| `thesis-literature-citation-review` | `profile` | `thesis_literature_citation_reviewer` | evidence-producer | workspace-write | `outputs/literature_citation_review.md` | standalone review by `thesis_evidence_calibrator`, or downstream synthesis review for used findings | manifest evidence checks |
